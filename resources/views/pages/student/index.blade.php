              ...
              <tr>
                        ...
                        <td>
                          ...
                          <form action="{{url('student/toggleStatus')}}" method="POST">
                            @csrf<input type="hidden" name="sid" value="{{$item->id}}">
                        ...
                        <td>
                            <a  class="btn btn-sm btn-info" title="View More" data-toggle="modal" data-target="#mymodal{{$item}}"><i class="fa fa-eye"></i></a>
                    ...
                    <!-- Scrollable modal -->
                    <div class="modal fade" id="mymodal{{$item}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
